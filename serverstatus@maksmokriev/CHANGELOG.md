...
* removed status-postfix (-OK, -ERROR) as status-icon and status-color looks like enough
* added configurable font size
* added configurable fixed widget size
* added default server as an example for start
