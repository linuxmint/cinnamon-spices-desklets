...
MyDesklet.prototype = {
  ...
  _setupLayout() {
    ...
    this._mainContainer.add_child(this.textLabel);
    this._mainContainer.add_child(this.daysLabel);
  ...
  updateUI: function () {
    if (this.textLabel) {
      ...
      this.textLabel.set_style(`font-size: ${this.textLabelFontSize}px; color: ${this.colorLabel};`);
    }
  ...
  on_desklet_removed: function () {
    if (this.timeout) Mainloop.source_remove(this.timeout);
    if (this.textLabel) this._mainContainer.remove_child(this.textLabel);
    if (this.daysLabel) this._mainContainer.remove_child(this.daysLabel);
