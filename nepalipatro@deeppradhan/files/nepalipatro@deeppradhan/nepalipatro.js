...
function BikramSambat() {
	...
	if (arguments.length === 3) {
		...
		if (gregorian instanceof Date && !isNaN(gregorian.valueOf())) {
			...
			date = this.epoch.bikramSambat.date; //changed in the year month array below. needs the aray verification for accuracy 
...
BikramSambat.prototype = {
		...
		// Length of month according to year //fixed the months in the nepali year 2081 // its a temporary fix and is to be fixed as the date drifts
		monthLength: {
